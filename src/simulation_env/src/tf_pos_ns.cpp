...
int main(int argc, char** argv){
  ...
  while(n.ok()){
    ...
    odom_trans.header.frame_id = odom_s.c_str();
    odom_trans.child_frame_id = base_footprint_s.c_str();
    ...
    odom.header.frame_id = odom_s.c_str();
    ...
    //set the velocity
    odom.child_frame_id = base_footprint_s.c_str();
